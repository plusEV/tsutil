...
def streaker(np.ndarray[long,ndim=1] times, np.ndarray[long,ndim=1] prices, 
    ...
    cdef:
        ...
        long i =0, win_size = window_size, t_diff, j, window_start,ref
        double tots_buys,tots_sells
